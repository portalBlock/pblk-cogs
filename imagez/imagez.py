...
class ImagezCog(commands.Cog):
    ...
    @_imagez.group(name="fonts")
    async def _imagez_fonts(self, ctx: commands.Context):
        """Manages imagez fonts."""
        pass

    @_imagez_fonts.command(name="download")
    async def _imagez_fonts_download(self, ctx: commands.Context, name: str, link: str):
    ...
    @_imagez_fonts.command(name="delete")
    async def _imagez_fonts_delete(self, ctx: commands.Context, name: str):
